...
import com.to.models.Student;
import com.to.models.Subject;
import com.to.models.Teacher;
import com.to.models.Class;
...
public class AdminControllerServlet extends HttpServlet {
	...
	private void login(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		if (username.toLowerCase().equals("user") && password.toLowerCase().equals("admin")) {
